...
export default function Root(props) {
    ...
    <div className="w-[800px] h-[480px] flex flex-col">
        <div className="h-[60px]">
            <div className="h-full w-full bg-kramer flex justify-between p-2 items-center">
        ...
        <div className="h-[30px]">
                <div className="h-full w-full bg-kramer-light flex justify-between items-center px-2 text-gray-600">
                    <span>HOME</span>
        ...
        <div className="h-[15px] bg-kramer w-full"></div>
    </div>
    </LabContext.Provider>
    )
}